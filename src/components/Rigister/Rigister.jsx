    ...
    <title>Register </title>
      ...
      <div className="w-50 m-auto my-5">
        ...
        <form onSubmit={registerFormik.handleSubmit}>
          ...
          <input value={registerFormik.values.email} onChange={registerFormik.handleChange} type="text" className='form-control my-3' id="email" name='email' />
          ...
          <input value={registerFormik.values.password} onChange={registerFormik.handleChange} type="password" className='form-control my-3' id="password" name='password' />
          ...
          <input value={registerFormik.values.rePassword} onChange={registerFormik.handleChange} type="password" className='form-control my-3' id="rePassword" name='rePassword' />
          ...
          {isLoading ? <button type='button' className='btn bg-main text-white'><i className='fas fa-spinner fa-spin'></i></button> :
            <button disabled={!(registerFormik.isValid && registerFormik.dirty)} type='submit' className='btn bg-main text-white'>Register</button>
          }
        </form>
      </div>
    </>
